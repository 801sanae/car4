...
import com.model2.mvc.service.file.impl.FileServiceImpl;
...
//					String fileUrl= "http://"+java.net.InetAddress.getLocalHost().getHostAddress()+":"+request.getServerPort()+ctx.getContextPath()+"/image/"+fileName;
	...
	@RequestMapping("/carView1.do")
	public String carView(Model model, HttpSession session,HttpServletResponse response) throws Exception {
